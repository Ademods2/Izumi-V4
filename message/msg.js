...
const namabot = "ModsBOT" // Ganti Nama Bot Kalian
const nameown = "Ademods" // Ganti Nama Kalian
const numown = "0898-0330-708" // Ganti Nomor Kalian
const nameowner = "Ademods" // Ganti Nama Kalian
const footer = "ModsBOT 2022" // Ganti Nama Bot Kalian
const capt = "*By Ademods BOT*" // Ganti Nama Bot Kalian
const grup = "https://chat.whatsapp.com/H984ganTo0n6IuBlpMMEbh" // Ganti Link Group Kalian
const nomorown = "https://wa.me/628980330708" // Ganti Nomor Kalian
const note = "*_Bot Ini Masih Dalam Pengembangan Jika Ada Fitur Yang Eror Silakan Hubungi Owner!!!_*" // Kalau Mau Ganti Aja
const namagrup = "Group Ademods" // Ubah Nama Group Mu

// Setting Donasi
const gopay = "0898-0330-708" // Ganti Nomor Gopay Mu
const pulsa = "0898-0330-708" // Ganti No Pulsa Mu
const insta = "chris.tianid" // Ganti Nama IG Mu
const github = "Ademods2" // Ganti Nama Github Mu
